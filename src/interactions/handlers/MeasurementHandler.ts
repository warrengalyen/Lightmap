...
export class MeasurementHandler extends BaseInteractionHandler {
    ...
    private handleClickFromLight(
        ...
        const clickedVertexIndex = findVertexAtPosition(event.worldPos, vertices, MEASUREMENT_CLICK_TOLERANCE_FT);
    ...
    private handleClickFromVertex(event: InputEvent, _context: InteractionContext, vertices: Vector2[]): boolean {
