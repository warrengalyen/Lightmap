<script lang="ts">
    ...
    onMount(() => {
        ...
        dragManager = new DragManager({
            ...
            onMoveObstacle: (obstacleId, vertexPositions) =>
                moveObstacle(obstacleId, vertexPositions),
        ...
        drawingHandler = new DrawingHandler(
            ...
            {
                onUpdateDrawingVertices: (vertices) =>
                    editorRenderer.updateDrawingVertices(vertices),
        ...
        boxSelectionHandler = new BoxSelectionHandler(
            ...
            },
            {
                ...
                onBoxSelectionUpdate: (start, current) =>
                    editorRenderer.setSelectionBox(start, current),
                    ...
                    new GrabModeDragOperation(
                        {
                            ...
                            getDoors: () => currentRoomState.doors ?? [],
                            getDoorById: (id) =>
                                (currentRoomState.doors ?? []).find((d) => d.id === id),
                            getDoorsByWallId: (wallId) =>
                                getDoorsByWallId(currentRoomState, wallId),
